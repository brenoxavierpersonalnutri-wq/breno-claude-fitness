...
## 🚨 GATE INICIAL DO LPSG · pesquisa + briefing aprovado ANTES de qualquer fase

> **Trava transversal aplicada a TODOS os 12 agentes do squad.** Qualquer agente que receba pedido de executar uma fase LPSG (página · copy · oferta · criativo · tráfego · automação · mensageria · dashboard · operação · CS) **sem briefing aprovado e assinado pelo expert**, deve RECUSAR e direcionar pro `@estrategista-turbo` ou `lpsg-master-turbo`.

### Sequência inicial OBRIGATÓRIA (não admite atalho)
...
TRIGGER: usuário pede "executar LPSG" / "crie meu LPSG" / "começar projeto"
   ...
   │                                  + sobe no Google Drive (pasta do cliente)
   │                                  + frase de aprovação no rodapé
   │
   └── 4. ⏸️ PAUSA · aguarda aprovação do expert no Google Docs/Word
          3 opções: (a) aprovo · (b) aprovo com ajustes · (c) não aprovo
          Expert marca alterações em modo de revisão
          Operador avisa "briefing aprovado · pode seguir"
                                       │
                                       ▼
                  SÓ AGORA começa Fase 1 (estrutura-aulas-lpsg-turbo)
```

### O que cada agente faz se for invocado SEM briefing aprovado

```
"Não posso executar [a fase X] ainda. O LPSG exige briefing aprovado
...
Volta pro @estrategista-turbo (ou lpsg-master-turbo) pra rodar o gate inicial.
Depois eu executo [a fase X] com o contexto certo."
```
...
**Resposta padrão a "pula isso, já tenho tudo na cabeça":**
> "Pesquisa + briefing são obrigatórios no método. Leva ~30-60 min agora. Evita 5-10h de retrabalho depois. Vou rodar."

---

## Trava de coreografia 5+1 (Pré-pitch · LPSG)

> **A Aula 4 (QUINTA) é A ÚNICA aula com pré-pitch.** Não tem pré-pitch na sexta. Não tem repitch na sexta. Quem joga apresentação de produto pra Aula 5 (sexta) está ERRANDO a coreografia.

| Aula | Dia | Função | O que TEM | O que NÃO TEM |
|---|---|---|---|---|
| **4** | **Quinta** | **PRÉ-PITCH COMPLETO (único)** | (1) Apresentação do produto + ficha de interesse · (2) aviso CARRINHO (ficha entra 6h50 · geral 7h) · (3) aviso DOMINGO 20H revelação de preço/bônus | preço · bônus |
| **5** | **Sexta** | **Conclusão técnica + lembrete curto da ficha** | conteúdo técnico final · lembrete da ficha · reforço dos 2 avisos (domingo 20h · segunda 7h) | reapresentação do produto · pré-pitch · repitch · preço · bônus |
| **6** | **Domingo 20h** | **Pitch completo** | preço · bônus · condições · garantia · abertura carrinho na segunda (ficha 6h50 · geral 7h) | — |

**Auditoria rápida:** se a Aula 5 estiver com apresentação do produto, casos do produto, future pacing do produto ou linguagem de "pré-pitch", está NO LUGAR ERRADO · mover pra Aula 4 e refazer a Aula 5 como conclusão técnica.
