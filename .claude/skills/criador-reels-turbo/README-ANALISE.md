...
3. **Skills instaladas no projeto**: `criador-reels-turbo` e `criador-criativos-turbo`
...
```
Leia as skills criador-criativos-turbo (SKILL.md + references/estruturas-invisiveis.md + 
references/anatomia-hook.md + references/anatomia-body.md) e criador-reels-turbo 
...
```
Leia as skills criador-criativos-turbo e criador-reels-turbo (SKILL.md + todos os references 
de ambas).
