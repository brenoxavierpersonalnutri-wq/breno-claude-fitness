...
#   - Skill criador-reels-turbo instalada no projeto
#   - Skill criador-criativos-turbo instalada no projeto
#
# O QUE FAZ:
...
CONTEXTO IMPORTANTE:
- Você tem acesso à skill "criador-criativos-turbo" que contém frameworks de análise de ads escalados (estruturas invisíveis, hooks, body, bullets, disparos de dopamina, invalidação redundante, escada de solução 1.0→2.0, lead associativa, future pacing)
- Você tem acesso à skill "criador-reels-turbo" que contém frameworks de análise de conteúdo orgânico (4 estruturas de condução, 6 tipos de hook para orgânico, momentos de personalidade, gerador de temas, fechamento/CTA/assinatura)
