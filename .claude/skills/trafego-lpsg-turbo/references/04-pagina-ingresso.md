...
>
> A página de ingresso é responsabilidade da skill **`paginas-lpsg-turbo`** — lá está a estrutura completa: 5 variações com **arquétipos premium drasticamente distintos** (Editorial Longform · Bold Magazine Cover · Interativo/Calculadora · Storytelling/Timeline · Manifesto/Contrarian — ver `paginas-lpsg-turbo/references/09-arquetipos-premium.md`), stack Next.js + Tailwind + Vercel, performance LCP < 1.5s, e os dois modos de output (implementa aqui ou brief para Claude Design). 1ª dobra obrigatória apenas com data + garantia · resto livre por arquétipo.
