...
> **REGRA-MÃE (alinhada ao cap 4+4):** depois do D1, **ZERO disparo em massa** (API broadcast ou grupo) sobre o carrinho. D+1 a D+7 é **100% comercial 1:1** — território do `@closer-turbo`. As antigas "mensagens 18h via API" deste cronograma foram REVOGADAS (violavam a regra D2-D7 zero massa de `mensageria-lpsg-turbo`).
