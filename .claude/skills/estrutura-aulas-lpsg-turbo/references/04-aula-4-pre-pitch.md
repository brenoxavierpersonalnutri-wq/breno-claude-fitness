...
> **A Aula 4 (QUINTA) é A ÚNICA aula com pré-pitch no modelo 5+1.** Não tem pré-pitch na sexta. Não tem repitch na sexta. A sexta (Aula 5) é só conclusão técnica + lembrete curto da ficha — **zero reapresentação do produto**. Quem joga pré-pitch pra sexta está ERRANDO a coreografia.

> **Missão única da Aula 4:** fazer a pessoa **sair desejando** o produto que será vendido no domingo. **NÃO fala preço. NÃO fala bônus.** Abre a ficha de interesse.

---

## 🚨 OS 3 ELEMENTOS OBRIGATÓRIOS DA AULA 4 (CHECKLIST INEGOCIÁVEL)

Toda Aula 4 PRECISA conter os 3 elementos abaixo. **Se falta um, a aula está incompleta. Se um deles aparecer na Aula 5, está NO LUGAR ERRADO.**

| # | Elemento | O que entregar |
|---|---|---|
| 1 | **Apresentação completa do produto + chamada pra ficha de interesse** | O que é · o que transforma · pra quem é / NÃO é · estudos de caso · future pacing. No fim: abre a ficha. **SEM preço · SEM bônus.** |
| 2 | **Aviso explícito de quando o CARRINHO ABRE NA SEGUNDA** | "Quem preencheu a ficha entra **6h50** (10 min antes · janela exclusiva com bônus único). O carrinho geral abre **7h**." |
| 3 | **Aviso explícito de que o DOMINGO ÀS 20H tem a REVELAÇÃO DE PREÇO E BÔNUS** | "Domingo às 20h eu abro tudo — valores, bônus, condições, garantia." |

> Os 3 viram **uma única chamada de fechamento** no final da aula: "preenche a ficha · domingo 20h eu abro preço e bônus · segunda quem tem ficha entra 6h50 e o carrinho geral abre 7h". Essa frase é a assinatura da Aula 4.
...
> Detalhe do formato em `criador-paginas-low-ticket-turbo/references/estudo-de-caso-narrativo.md`.

### Bloco 5 — Abertura da ficha + os 3 avisos (3-5 min) ⭐
**Bloco crítico e OBRIGATÓRIO.** Aqui entram os 3 elementos canônicos da Aula 4. Sem isso, o domingo abre cego e a coreografia quebra.

> "Então olha só. Hoje eu não vou falar de valor, nem de bônus, nem de condição. Isso tudo é **domingo às 20h** — é onde eu abro o jogo completo: **valores, bônus, condições, garantia, tudo.** Separa a tua noite de domingo.
>
> E **segunda-feira**, quem preencheu a ficha entra **6h50** — 10 minutos antes de todo mundo, com um bônus único dessa janela. O carrinho geral abre **7h em ponto**.
>
> Mas pra entrar nessa lista, eu preciso saber uma coisa hoje: **quem aqui quer fazer parte disso?**
>
> Eu abri uma **ficha de interesse**. Não é compra, não é compromisso. É você me dizer 'eu quero o {NOME_PRODUTO}'. Quem preenche entra na lista de prioridade.
>
> **Não é pra todo mundo.** É pra quem sentiu que quer o próximo nível. Link 👇: **{LINK_FICHA_INTERESSE}**"

> **Os 3 elementos canônicos da Aula 4 (verificar antes de gravar):**
> - ✅ Ficha aberta + apresentação do produto completa (Blocos 1-4)
> - ✅ Aviso "DOMINGO às 20h tem revelação de preço e bônus"
> - ✅ Aviso "SEGUNDA: ficha entra 6h50 (janela exclusiva) · carrinho geral 7h"

> **Trava:** a ficha mede DESEJO, não vende. Não cita preço nem bônus. A vantagem de preencher é "receber o jogo completo em primeira mão no domingo + entrar 6h50 na segunda (10 min antes do carrinho geral), com bônus único dessa janela".
...
## 🎣 Gancho da próxima aula (com os 3 avisos reforçados)
...
>
> Sábado, tira-dúvidas ao vivo. **Domingo às 20h, eu abro o jogo completo do {NOME_PRODUTO} — valores, bônus, condições, tudo.** E **segunda-feira, quem preencheu a ficha entra 6h50** (10 min antes, com bônus único) · o **carrinho geral abre 7h**.
>
...
**Os 3 elementos canônicos (não podem faltar):**
- [ ] (1) Apresentação completa do produto + abertura da ficha de interesse
- [ ] (2) Aviso explícito "SEGUNDA: ficha entra 6h50 (janela exclusiva) · carrinho geral 7h"
- [ ] (3) Aviso explícito "DOMINGO ÀS 20H — revelação de preço e bônus"
...
- [ ] Bloco 5 (ficha + 2 avisos) com tempo protegido (mínimo 3 min)
- [ ] Gancho repete os 2 avisos (domingo 20h preço/bônus + segunda 6h50 ficha / 7h carrinho geral)
...
- Estudo de caso narrativo: `criador-paginas-low-ticket-turbo/references/estudo-de-caso-narrativo.md`
- Mensageria da quinta: `mensageria-lpsg-turbo/SKILL.md` (coreografia pré-pitch · sem preço/bônus)
